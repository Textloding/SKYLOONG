...
const char *i18n_dict[][2] = {
    ...
    {"检查更新", "Check update"},
    {"正在更新...\n如需取消更新，请在进度达到95%之前\n关闭设备电源", "Upgrade in progress\nTo stop updating, please turn off the device before it reaches 95%"},
    {"OTA更新已启动", "OTA initialized"},
    {"OTA更新完成", "OTA finished"},
    {"OTA更新失败", "OTA failed"},
    {"OTA准备中", "OTA preparing"},
    {"发现新版本", "New version available"},
    {"已经是最新版本", "Latest already"},
    {"内部错误", "Internal error"},
    {"无法连接服务器", "Cannot talk to server"},
    {"立即更新", "Update now"},
    {"APS 界面使能", "Enable APS Screen"},
    {"允许切换到APS 界面", ""},
    {"GIF 界面使能", "Enable GIF Screen"},
    {"允许切换到GIF 界面", ""},
    {"天气界面使能", "Enable Weather"},
    {"允许切换到天气界面", ""},
