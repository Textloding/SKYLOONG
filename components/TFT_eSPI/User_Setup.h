...
#define TFT_D1   48  // so a single register write sets/clears all bits.
#define TFT_D2   45  // Pins can be randomly assigned, this does not affect
#define TFT_D3   38  // TFT screen update performance.
#define TFT_D4   39
#define TFT_D5   40
#define TFT_D6   41
#define TFT_D7   42
...
#define TFT_PWR   3  // Power control pin
