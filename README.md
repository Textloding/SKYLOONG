...
- 天气城市、天气源、接口地址、API Key / AppCode、经纬度配置。Key 只用于保存，不在普通状态接口中回显。
...
系统页可设置设备音量、视频声音、按键音、天气城市、天气数据源、经纬度、时区、语言和设备重启。
...
- 阿里云市场 72158 精准天气：需要在阿里云云市场开通商品并复制 AppCode。
- 阿里云市场 10812 万维易源：需要在阿里云云市场开通商品并复制 AppCode。
